package com.example.neuroview.data
...
object TumorData {
    fun getAllTumors(): List<TumorType> = listOf(
        TumorType(
            ...
            """.trimIndent(),
            imageResource = com.example.neuroview.R.drawable.sample_glioma_image
        ),
        TumorType(
            name = "Meningioma",
            ...
            """.trimIndent(),
            imageResource = com.example.neuroview.R.drawable.sample_meningioma_image
        ),
        TumorType(
            name = "Pituitary",
            ...
            """.trimIndent(),
            imageResource = com.example.neuroview.R.drawable.sample_pituitary_image
        )
    )
